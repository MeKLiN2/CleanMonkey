...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/493696/Hunter%20Stumblechat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/493696/Hunter%20Stumblechat%20Script.meta.js
// ==/UserScript==
...
// Function to toggle visibility of WebSocket messages div
function toggleWebSocketMessagesDiv() {
    const webSocketMessagesDiv = document.getElementById("webSocketMessages");
    if (webSocketMessagesDiv) {
        webSocketMessagesDiv.style.display = webSocketMessagesDiv.style.display === "none" ? "block" : "none";
    }
}

// Add a button to toggle visibility of WebSocket messages div
const toggleMessagesButton = document.createElement("button");
toggleMessagesButton.textContent = "Toggle Messages";
toggleMessagesButton.style.position = "fixed";
toggleMessagesButton.style.top = "50px"; // Adjust top position as needed
toggleMessagesButton.style.left = "10px"; // Adjust left position as needed
